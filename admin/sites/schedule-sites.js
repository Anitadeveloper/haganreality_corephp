...
function ScheduleSites_js () {
	...
	function Main(){
		window.requestAnimationFrame(function(timestamp){
			if(loading === true && document.body.id === "schedule-sites"){
				Initialisation();
				loading = false;
			}
			
			if(startTime !== undefined && document.body.id === "schedule-sites"){
	...
	function site(id = '', name = '', url = '', obj = null, scheduled = null, update_scheduled = null){
		this.id = id;
		this.name = name;
		this.url = url;
		this.parameter = '';
		...
		this.update_scheduled = update_scheduled;
	}
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState === 4){
				...
				for(var i = 0; i < retrieved_sites.length; i++){
					...
					sites[i + last_sites_retrieved].scheduled = SetScheduled(retrieved_sites[i].schedule_ts);
					sites[i + last_sites_retrieved].update_scheduled = JSON.parse(JSON.stringify(sites[i + last_sites_retrieved].scheduled));
					//set site object
	...
	function SetSite(site){
		...
		site.obj.querySelector('.lbl-00-div-01-div-00-div-01-div-00-div-00').childNodes[0].nodeValue = DateFormat(site.scheduled);
	...
	function SetSiteActions(site){
		...
		site.obj.querySelector('.btn-00-div-01-div-00-div-01-div-00-div-00').addEventListener('click', function(){
			...
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[0].innerHTML = Zerofill(site.scheduled.month,2);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[1].innerHTML = Zerofill(site.scheduled.day,2);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[2].innerHTML = Zerofill(site.scheduled.year,4);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-01-div-00-div-01-div-00')[0].innerHTML = Zerofill(site.scheduled.hour,2);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-01-div-00-div-01-div-00')[1].innerHTML = Zerofill(site.scheduled.minutes,2);
	...
	function SetScheduled(timestamp){
		//get date
		var date = new Date(timestamp * 1000 - 3600000 * 8);
	...
	function DateFormat(scheduled){
		//get date from set date	
		var set_date = Zerofill(scheduled.month,2) + '/' + Zerofill(scheduled.day,2) + '/' + Zerofill(scheduled.year,4);
		var set_time = Zerofill(scheduled.hour, 2) + ':' + Zerofill(scheduled.minutes, 2) + ' PT';
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState === 4){
				...
				for(var i = 0; i < retrieved_sites.length; i++){
					...
					//add to sites array
					sites_search.length ++;
					sites_search[i] = new site(retrieved_sites[i].id, retrieved_sites[i].name, retrieved_sites[i].url, template, SetScheduled(retrieved_sites[i].schedule_ts), JSON.parse(JSON.stringify(SetScheduled(retrieved_sites[i].schedule_ts))));
					//set site object
	...
	function InitialiseDialogs(){
		...
		div_00_div_01_div_00.querySelector('#btn-00-div-00-div-01-div-00').addEventListener('click', function(){
			UnscheduleSiteXHR(div_00_div_01_div_00.focus_site);
		});
		//edit site dialog
		div_00_div_01_div_00.querySelector('#btn-01-div-00-div-01-div-00').addEventListener('click', function(){
			ScheduleSite(div_00_div_01_div_00.focus_site);
		});
		//buttons
		div_00_div_01_div_00.querySelectorAll('.btn-00-div-00-div-00-div-00-div-01-div-00')[0].addEventListener('click', function(){
			//increase month
			div_00_div_01_div_00.focus_site.update_scheduled.month = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.month,12)+1;
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[0].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.month,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-01-div-00-div-00-div-00-div-01-div-00')[0].addEventListener('click', function(){
			//decrease month
			div_00_div_01_div_00.focus_site.update_scheduled.month = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.month - 2,12) + 1;
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[0].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.month,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-00-div-00-div-00-div-00-div-01-div-00')[1].addEventListener('click', function(){
			//increase day
			div_00_div_01_div_00.focus_site.update_scheduled.day = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.day,31)+1;
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[1].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.day,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-01-div-00-div-00-div-00-div-01-div-00')[1].addEventListener('click', function(){
			//decrease day
			div_00_div_01_div_00.focus_site.update_scheduled.day = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.day - 2,31) + 1;
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[1].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.day,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-00-div-00-div-00-div-00-div-01-div-00')[2].addEventListener('click', function(){
			//increase year
			div_00_div_01_div_00.focus_site.update_scheduled.year = div_00_div_01_div_00.focus_site.update_scheduled.year + 1;
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[2].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.year,4);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-01-div-00-div-00-div-00-div-01-div-00')[2].addEventListener('click', function(){
			//decrease year
			div_00_div_01_div_00.focus_site.update_scheduled.year = div_00_div_01_div_00.focus_site.update_scheduled.year - 1;
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-00-div-00-div-01-div-00')[2].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.year,4);
		});
		
		div_00_div_01_div_00.querySelectorAll('.btn-00-div-00-div-01-div-00-div-01-div-00')[0].addEventListener('click', function(){
			//increase hours
			div_00_div_01_div_00.focus_site.update_scheduled.hour = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.hour + 1,24);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-01-div-00-div-01-div-00')[0].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.hour,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-01-div-00-div-01-div-00-div-01-div-00')[0].addEventListener('click', function(){
			//decrease hours
			div_00_div_01_div_00.focus_site.update_scheduled.hour = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.hour - 1,24);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-01-div-00-div-01-div-00')[0].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.hour,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-00-div-00-div-01-div-00-div-01-div-00')[1].addEventListener('click', function(){
			//increase minutes
			div_00_div_01_div_00.focus_site.update_scheduled.minutes = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.minutes + 1,60);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-01-div-00-div-01-div-00')[1].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.minutes,2);
		});
		div_00_div_01_div_00.querySelectorAll('.btn-01-div-00-div-01-div-00-div-01-div-00')[1].addEventListener('click', function(){
			//decrease minutes
			div_00_div_01_div_00.focus_site.update_scheduled.minutes = Modulo(div_00_div_01_div_00.focus_site.update_scheduled.minutes - 1,60);
			div_00_div_01_div_00.querySelectorAll('.div-00-div-00-div-01-div-00-div-01-div-00')[1].innerHTML = Zerofill(div_00_div_01_div_00.focus_site.update_scheduled.minutes,2);
		});
	...
	function UnscheduleSiteXHR(site){
		//hide sites
		div_01_div_00.style.display = 'none';
		div_00_div_01_div_00.style.display = 'none';
		html.style.overflow = '';
		...
		xhr.open('POST', url, true);
		xhr.setRequestHeader("Content-Type", "application/json");
		xhr.setRequestHeader("Site-Action", 5);
		xhr.setRequestHeader("Site-Id", site.id);
		xhr.send();
	...
	function ScheduleSite(site){
		//update scheduled and the label
		site.scheduled = JSON.parse(JSON.stringify(site.update_scheduled));
		site.obj.querySelector('.lbl-00-div-01-div-00-div-01-div-00-div-00').childNodes[0].nodeValue = DateFormat(site.update_scheduled);
		
		//if search object
		if(btn_00_asd_00_div_00_div_00.state !== 0){
			for(var i = 0; i < sites.length; i++){
				if(sites[i].id === site.id){
					sites[i].obj.querySelector('.lbl-00-div-01-div-00-div-01-div-00-div-00').childNodes[0].nodeValue = DateFormat(site.update_scheduled);
				}
			}
		}
		
		var scheduled_ts = GetTimestamp(site.update_scheduled);
		
		ScheduleSiteXHR(site, scheduled_ts);
	}
	...
	function ScheduleSiteXHR(site, scheduled_ts){
		//hide sites
		div_01_div_00.style.display = 'none';
		div_00_div_01_div_00.style.display = 'none';
		html.style.overflow = '';
		...
		xhr.open('POST', url, true);
		xhr.setRequestHeader("Content-Type", "application/json");
		xhr.setRequestHeader("Site-Action", 4);
		xhr.setRequestHeader("Site-Id", site.id);
		xhr.setRequestHeader("Schedule-Ts", scheduled_ts);
		xhr.send();
		...
		xhr.onreadystatechange = function(){
			...
			if(xhr.readyState === 4){
				//force refresh of aside
				UPDATE_SITE_COUNTERS = true;
				if(xhr.getResponseHeader('Action') === 'Unscheduled'){
					//if not in search
					if(btn_00_asd_00_div_00_div_00.state === 0){
						//remove child
						site.obj.parentElement.removeChild(site.obj);
