...
<body id='<?= $page_title ?>'>
	<div id="div-00">
		...
		<section id='sec-00'>
			...
			<h3 id='h3-00-sec-00'>Add Agent </h3>
			<p id='p-00-sec-00'> Enter your details of Agent to join the Hagan Realty admin system </p>
			...
			<div id='div-00-sec-00'>
				<div id='div-00-div-00-sec-00'>
					...
					<input id='ipt-00-div-00-div-00-sec-00' placeholder="Agent Full Name" type='text'>
				</div>
			...
			<div id='div-01-sec-00'>
				<div id='div-00-div-01-sec-00'>
					...
					<input id='ipt-00-div-00-div-01-sec-00' placeholder="Occupation" type='text'>
				</div>
			...
			<div id='div-02-sec-00'>
				<div id='div-00-div-02-sec-00'>
					<svg id='svg-00-div-00-div-02-sec-00' viewBox="0 0 10 10" preserveAspectRatio="none">
						<path id='pth-00-svg-00-div-00-div-02-sec-00' d='M 5 6 A 3 3 0 0 1 5 0 A 3 3 0 0 1 5 6'></path>
						<path id='pth-01-svg-00-div-00-div-02-sec-00' d='M 0 10 A 6 6 0 0 1 10 10 Z'></path>
					</svg>
			...
			<div id='div-03-sec-00'>
				<div id='div-00-div-03-sec-00'>
					...
					<input id='ipt-00-div-00-div-03-sec-00' placeholder="Phone No" type="text">
			...
			<div id='div-04-sec-00'>
				<div id='div-00-div-04-sec-00'>
					<svg id='svg-00-div-00-div-04-sec-00' viewBox="0 0 10 10" preserveAspectRatio="none">
						<path id='pth-00-svg-00-div-00-div-04-sec-00' d='M 1 2 L 9 2 L 5 5 Z M 1 2 L 1 7 L 9 7 L 9 2'></path>
					</svg>
					<input id='ipt-00-div-00-div-04-sec-00' placeholder="Office Phone No" type='text'>
				</div>
			...
			<div id='div-05-sec-00'>
				<div id='div-00-div-05-sec-00'>
					<svg id='svg-00-div-00-div-05-sec-00' viewBox="0 0 10 10" preserveAspectRatio="none">
						<path id='pth-00-svg-00-div-00-div-05-sec-00' d='M 1 2 L 9 2 L 5 5 Z M 1 2 L 1 7 L 9 7 L 9 2'></path>
					</svg>
					<input id='ipt-00-div-00-div-05-sec-00' placeholder="Facebook Link" type='text'>
				</div>
				<label id='lbl-00-div-05-sec-00'></label>
			</div>
			<div id='div-06-sec-00'>
				<div id='div-00-div-06-sec-00'>
					<svg id='svg-00-div-00-div-06-sec-00' viewBox="0 0 10 10" preserveAspectRatio="none">
						<path id='pth-00-svg-00-div-00-div-06-sec-00' d='M 5 6 A 3 3 0 0 1 5 0 A 3 3 0 0 1 5 6'></path>
						<path id='pth-01-svg-00-div-00-div-06-sec-00' d='M 0 10 A 6 6 0 0 1 10 10 Z'></path>
					</svg>
					<input id='ipt-00-div-00-div-06-sec-00' placeholder="Website" type="text">
				</div>
				<label id='lbl-00-div-06-sec-00'></label>
			</div>
			<div id='div-07-sec-00'>
				<div id='div-00-div-07-sec-00'>
					<svg id='svg-00-div-00-div-07-sec-00' viewBox="0 0 10 10" preserveAspectRatio="none">
						<rect id='rct-00-svg-00-div-00-div-07-sec-00' width='8' height='4.5' x='1' y='5.5' rx='0.5' ry='0.5'></rect>
						<path id='pth-00-svg-00-div-00-div-07-sec-00' d='M 2.5 6 L 2.5 4 A 2.5 2.5 0 0 1 7.5 4 L 7.5 6'></path>
					</svg>
					<input id='ipt-00-div-00-div-07-sec-00' placeholder="Description" type='text'>
				</div>
				<label id='lbl-00-div-07-sec-00'></label>
			</div>
			<div id='div-08-sec-00'>
				<div id='div-00-div-08-sec-00'>
					<svg id='svg-00-div-00-div-08-sec-00' viewBox="0 0 10 10" preserveAspectRatio="none">
						<rect id='rct-00-svg-00-div-00-div-08-sec-00' width='8' height='4.5' x='1' y='5.5' rx='0.5' ry='0.5'></rect>
						<path id='pth-00-svg-00-div-00-div-08-sec-00' d='M 2.5 6 L 2.5 4 A 2.5 2.5 0 0 1 7.5 4 L 7.5 6'></path>
					</svg>
					<input id='ipt-00-div-00-div-08-sec-00' type='file'>
				</div>
				<label id='lbl-00-div-08-sec-00'></label>
